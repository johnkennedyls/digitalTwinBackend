...
public class PlantController {
	   ...
	   @Autowired
	    ...
	    @PostMapping("created")
	    public ResponseEntity<Plant> addPlant(@RequestBody Plant plantDTO) throws Exception {
	    ...
	    public ResponseEntity<Plant> modifyPlant(@RequestBody Plant plant, @PathVariable Integer id) throws Exception {
	        Plant modifiedPlant = plantService.modifyPlant(plant, id);
